...
def objective(params):        
    ...
    for i in range(3):
        #initialize
        model = DecisionTreeRegressor(min_samples_split=int(params['split']), min_samples_leaf=int(params['leaf']), max_features=int(params['features']))
        #model train
...
for h in range(4):    
    ...
    with open('DTR_trials_t'+str(h+1)+'.pkl', 'wb') as f:
