...
# Traffic reader IDs
samples_month_val = 22764 #hardcode for NYC
samples_month_train = 45528 #hardcode for NYC
...
for h in range(4):  
    ...
    with open('Attention_trials_t+'+str(h+1)+'.pkl', 'wb') as f:
